...
class BlipForQuestionAnswering(BlipPreTrainedModel):
    ...
    def __init__(self, config: BlipConfig):
        ...
        self.vision_model_plus = SiglipModel.from_pretrained("/home/pengfei/siglip-base-patch16-224").vision_model
    ...
    def forward(
        ...
        vision_outputs = self.vision_model_plus(
            pixel_values=pixel_values,
            output_attentions=output_attentions,
            output_hidden_states=output_hidden_states,
            return_dict=return_dict,
        ...
        image_attention_mask = torch.ones(image_embeds.size()[:-1], dtype=torch.long).to(input_ids.device)
        ...
        #
        # # === 1. 读取原始 TIFF 图像 ===
        # image_path = "/home/pengfei/rsvqa/data/RSVQA_LR/Image/Images_LR/234.tif"  # 请替换为你的 TIFF 图像路径
        ...
        # batch_idx = 359 # 选择 batch 里的第 1 个样本
        # head_idx = 2  # 选择第 1 个注意力头
        ...
        # # === 6. 将热力图叠加到原图上 ===
        # alpha = 0.5  # 透明度
        # overlayed_image = cv2.addWeighted(original_image, 0.6, heatmap, alpha, 0)
        #
        # # === 7. 显示结果 ===
        ...
        # plt.axis("off")
        #
        # plt.savefig("/home/pengfei/mamba/assets/relitu_359234.svg", bbox_inches='tight', pad_inches=0,
        #             dpi=300)
        #
